                    ...
                    @foreach ($products as $product)
                        <li class="list-group-item">
                            ...
                            <div class="btn-group cartBtnGroup">
                                ...
                                <a class="btn qtyBtn rounded bg-warning" href="{{ route('cart.addToCart', ['id' => $product['item']['id']]) }}"><i class="far fa-minus-square iconColor"></i></a>
                                <a class="btn qtyBtn rounded bg-danger" href="{{ route('cart.addToCart', ['id' => $product['item']['id']]) }}"><i class="far fa-trash-alt iconColor"></i></a>
                            </div>
                        </li>
                    @endforeach
                </ul>
